      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-12">
                    <p class="mt-1">
                        Alacak olduğunuz {{ $item->short_name }} {{ $item_name1 }} envanterinize gidecektir. Kuşanmak için <a href="{{ route('get-inventory') }}" class="{{$user->character->school_class->color}}-color-link">envanter</a> sayfanızı ziyaret etmeniz gerekmektedir.
                    </p>
                </div>
            </div>
            <hr>
