<div class="col-md-12 title">
    <div class="card-title text-center fw-bold mb-4 pb-2 f-36 bb-white">
        <div class="d-flex d-align d-center">
            ...
            <span data-toggle="tooltip" data-placement="top" title="İksir kaliteleri hakkında bilgi almak için tıklayın.">
...
<div class="col-md-12">
    <div class="table-responsive">
        <table class="table table-bordered">
            <tr>
                <td class="bg-dark-theme text-center fw-bold">Adı</td>
                <td class="bg-dark-theme text-center fw-bold">Kalite</td>
                <td class="bg-dark-theme text-center fw-bold">Fiyatı</td>
                <td class="bg-dark-theme text-center fw-bold">Durum</td>
            </tr>
            @foreach ($potions as $material)
                <tr>
                    ...
                    @foreach($character_materials->where('character_id', Auth::user()->character->id)
                        ->where('material_id', $material->id) as $character_potion)
                        @php
                            $material_status = 1;
                            $current_material_id = $character_potion->id;
                            $current_material_count = $character_potion->count;
                        @endphp
                    @endforeach
                    <td>
